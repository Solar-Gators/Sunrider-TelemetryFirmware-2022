...
CPP_SRCS += \
../Drivers/etl/examples/Scheduler/Scheduler.cpp 

OBJS += \
./Drivers/etl/examples/Scheduler/Scheduler.o 

CPP_DEPS += \
./Drivers/etl/examples/Scheduler/Scheduler.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/etl/examples/Scheduler/%.o: ../Drivers/etl/examples/Scheduler/%.cpp Drivers/etl/examples/Scheduler/subdir.mk
...
clean: clean-Drivers-2f-etl-2f-examples-2f-Scheduler

clean-Drivers-2f-etl-2f-examples-2f-Scheduler:
	-$(RM) ./Drivers/etl/examples/Scheduler/Scheduler.d ./Drivers/etl/examples/Scheduler/Scheduler.o

.PHONY: clean-Drivers-2f-etl-2f-examples-2f-Scheduler
